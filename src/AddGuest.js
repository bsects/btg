...
export function AddGuest ({navigation, route}) {
    ...
    const [tamu, setTamu] = useState(route.params ? route.params.tamu : [{isMan: true, name:"BAYU SETIAWAN"}]);
        ...
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                <View style={[styles.section, {borderBottomWidth: 0}]}>
                    <Text style={[styles.blue, styles.bold, styles.big, styles.marginbottom]}>
                        Data Tamu
                    </Text>
                    ...
                    <View style={[styles.row, {justifyContent:'space-between', alignItems:'center'}]}>
                        ...
                        <TouchableOpacity onPress={()=>changeIsMan(index, !(item.isMan))}
                        ...
                        />
                        <TouchableOpacity onPress={()=>removeGuest(index)} style={{width:"10%"}}>
                            <SLI name="trash" size={35} color="#DB3700"/>
                        </TouchableOpacity>
                    </View>
                    ))}

                    <TouchableOpacity onPress={addNewGuest} style={{alignItems:'center', margin:20}}>
